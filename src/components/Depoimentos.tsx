  ...
  const depoimentos = [
    {
      ...
      empresa: "TechCorp",
      depoimento: "O trabalho do filmmaker superou todas as nossas expectativas. A qualidade cinematográfica e a atenção aos detalhes foram excepcionais. Nosso vídeo institucional ficou incrível!",
    ...
    },
    {
      ...
      cargo: "CEO",
      empresa: "StartupXYZ",
      depoimento: "Profissionalismo exemplar! Entregou o projeto no prazo e com uma qualidade que nos deixou impressionados. O comercial aumentou significativamente nossa conversão.",
    ...
    },
    {
      ...
      depoimento: "Criatividade e técnica em perfeita harmonia. O documentário que produziu para nosso festival foi premiado e elogiado por todos. Recomendo sem hesitar!",
    ...
    },
    {
      ...
      depoimento: "Meu videoclipe ficou cinematográfico! A visão artística dele transformou minha música em uma experiência visual única. Trabalho de altíssima qualidade.",
    ...
    },
    {
      ...
      depoimento: "Conseguiu capturar a essência da nossa causa de forma emocionante e respeitosa. O vídeo institucional nos ajudou a aumentar as doações em 40%.",
    ...
    },
    {
      ...
      depoimento: "Contou a história da nossa empresa de 50 anos de forma tocante e profissional. O documentário ficou perfeito para nosso aniversário corporativo.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            A satisfação dos meus clientes é minha maior recompensa. Veja o que eles têm a dizer sobre nossos projetos.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {depoimentos.map((depoimento) => (
            <div key={depoimento.id} className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 hover:bg-gray-800/70 transition-all duration-300 hover:scale-105">
              {/* Quote icon */}
              <div className="mb-4">
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h4 className="text-white font-semibold">{depoimento.nome}</h4>
                  <p className="text-gray-400 text-sm">{depoimento.cargo}</p>
                  <p className="text-orange-400 text-sm font-medium">{depoimento.empresa}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-orange-400 mb-2">4.9</div>
