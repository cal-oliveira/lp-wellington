...
const Hero = () => {
  const handleWhatsApp = () => {
    ...
    const message = "Olá! Gostaria de saber mais sobre seus serviços de filmmaking.";
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-gray-300 text-sm">Filmmaker Profissional</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            Sou um filmmaker freelancer especializado em criar conteúdo visual impactante. 
            De comerciais a documentários, trago sua visão à vida com qualidade cinematográfica.
          </p>
